...
class FLAGAdamW(AdamW):
    ...
    def __init__(
        ...
        *,
        ...
        if model_type not in self.model_modules_names_dict:
        ...
        self.steps = flag_steps
        self.step_size = flag_step_size
...
class ASAM(SGD):
    ...
    def __init__(self, params, model, base_lr: float, *, rho=0.5, eta=0.01,
                 momentum=0.9, weight_decay=0.0, clip_grad_norm=False):
        self.model = model
        self.params = params
        self.rho = rho
        self.eta = eta
