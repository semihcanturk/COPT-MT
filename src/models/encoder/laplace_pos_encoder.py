...
class LapPENodeEncoder(torch.nn.Module):
    ...
    """
    def __init__(self, dim_in, dim_pe, dim_emb, max_freqs, model_type='DeepSet', n_layers=1, n_heads=1, post_layers=1, batch_norm=False, expand_x=True, pass_as_var=False):
        super().__init__()
